...
export default function Home() {
  return (
    <div className="home-page" style={{ backgroundImage: "url(/water.jpg)" }}>
      ...
      <div className="home-content">
        <div className="left-section">
          ...
          <div className="hero-actions">
            ...
            <Link href="/dashboard" className="btn ghost">View Live Dashboard</Link>
          </div>
        </div>
      ...
      <div className="quick-links">
        {QUICK_LINKS.map((q) => (
          <Link key={q.to} href={q.to} className="quick-card">
            <h3>{q.title}</h3>
            <p>{q.desc}</p>
