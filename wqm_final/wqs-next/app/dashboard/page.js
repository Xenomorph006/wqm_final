...
export default function Dashboard() {
  ...
  return (
    <div className="dashboard" style={{ backgroundImage: "url(/water.jpg)" }}>
        ...
        <div className="main">
          ...
          <div className="table-section">
            <div className="table-head">
              ...
              <Link href="/reports" className="see-all">
                View all reports →
              </Link>
            </div>
            ...
            {predictions.items.length === 0 ? (
              <div className="empty-state">
                ...
                <Link href="/prediction" className="btn ghost">Start a Test</Link>
              </div>
            ) : (
              <table>
                <thead>
